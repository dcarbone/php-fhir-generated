...
interface DSTU1PrimitiveContainerTypeInterface extends ValueContainerTypeInterface
{
    /**
     ...
     */
    public function xmlSerialize(null|XMLWriter $xw,
                                 null|SerializeConfig $config,
