 ...
 */
interface Dstu1TypeInterface extends TypeInterface, \JsonSerializable
{
    /**
     ...
     * @param null|\DCarbone\PHPFHIRGenerated\Types\Dstu1TypeInterface $type Instance of this class to unserialize into.  If left null, a new instance will be created.
     * @return static
     */
    public static function xmlUnserialize(string|\SimpleXMLElement $element,
                                          null|UnserializeConfig $config = null,
                                          null|Dstu1TypeInterface $type = null): self;
